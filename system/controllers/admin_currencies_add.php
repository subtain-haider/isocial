...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/admin-currencies-add.php';

		} else {

            $for_load = 'max/admin-currencies-add.php';

		}

        $D->titlePhantom = $this->lang('admin_currencies_add_title_page');
		...
		$D->page_title = $this->lang('admin_currencies_add_title_page');    	

        $D->file_in_template = 'max/admin-currencies-add.php';
