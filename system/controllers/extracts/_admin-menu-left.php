...
*/
    ...
    $the_menu = array(
    array('id_option' => 'opt_adm_yourbrand', 'url' => 'admin/yourbrand', 'rel' => 'phantom', 'target' => 'dashboard-main-area-right', 'id_icono' => 'icom-adm-yourbrand', 'icono' => 'ico-admin-yourbrand.png', 'tag_title' =>  $this->lang('admin_menu_yourbrand'), 'text_option' =>  $this->lang('admin_menu_yourbrand'), 'id_notification' => '', 'num_notifications' => '', 'active' => (isset($D->id_menu) && $D->id_menu == 'opt_adm_yourbrand') ? TRUE : FALSE )
     );
    $D->admin_menu_left .= $this->designer->createBlockMenuLeftAdmin($the_menu, TRUE);
