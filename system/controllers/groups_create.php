...
*/
	...
	if ($D->isPhantom) {
        ...
        if ($D->layout_size == 'min') {
            $for_load = 'min/groups-create.php';
		} else {
            $for_load = 'max/groups-create.php';
		}

        $D->titlePhantom = $this->lang('dashboard_groups_create_title');
        ...
        $D->page_title = $this->lang('dashboard_groups_create_title');

        $D->file_in_template = 'max/groups-create.php';
