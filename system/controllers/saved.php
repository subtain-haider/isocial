...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/saved.php';

		} else {

            $for_load = 'max/saved.php';

		}

        $D->titlePhantom = $this->lang('dashboard_saved_title');
        ...
        $D->page_title = $this->lang('dashboard_saved_title');

        $D->file_in_template = 'max/saved.php';
