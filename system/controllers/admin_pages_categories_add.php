...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/admin-pages-categories-add.php';

		} else {

            $for_load = 'max/admin-pages-categories-add.php';

		}

        $D->titlePhantom = $this->lang('admin_pages_categories_add_title_page');
		...
		$D->page_title = $this->lang('admin_pages_categories_add_title_page');    	

        $D->file_in_template = 'max/admin-pages-categories-add.php';
