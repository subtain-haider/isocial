...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            $for_load = 'min/pages-create.php';
		} else {
            $for_load = 'max/pages-create.php';
		}

        $D->titlePhantom = $this->lang('dashboard_pages_create_title');
        ...
        $D->page_title = $this->lang('dashboard_pages_create_title');

        $D->file_in_template = 'max/pages-create.php';
