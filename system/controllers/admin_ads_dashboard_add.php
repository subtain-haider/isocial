...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/admin-ads-dashboard-add.php';

		} else {

            $for_load = 'max/admin-ads-dashboard-add.php';

		}

        $D->titlePhantom = $this->lang('admin_ads_dashboard_add_title_page');
		...
		$D->page_title = $this->lang('admin_ads_dashboard_add_title_page');    	

        $D->file_in_template = 'max/admin-ads-dashboard-add.php';
