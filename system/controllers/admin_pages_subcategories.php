...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/admin-pages-subcategories.php';

		} else {

            $for_load = 'max/admin-pages-subcategories.php';

		}

        $D->titlePhantom = $this->lang('admin_pages_subcategories_title_page');
		...
		$D->page_title = $this->lang('admin_pages_subcategories_title_page');    	

        $D->file_in_template = 'max/admin-pages-subcategories.php';
