...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/admin-articles-categories-add.php';

		} else {

            $for_load = 'max/admin-articles-categories-add.php';

		}

        $D->titlePhantom = $this->lang('admin_articles_categories_add_title_page');
		...
		$D->page_title = $this->lang('admin_articles_categories_add_title_page');    	

        $D->file_in_template = 'max/admin-articles-categories-add.php';
