...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/admin-products-categories-add.php';

		} else {

            $for_load = 'max/admin-products-categories-add.php';

		}

        $D->titlePhantom = $this->lang('admin_products_categories_add_title_page');
		...
		$D->page_title = $this->lang('admin_products_categories_add_title_page');    	

        $D->file_in_template = 'max/admin-products-categories-add.php';
