...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/admin-ads-profile-add.php';

		} else {

            $for_load = 'max/admin-ads-profile-add.php';

		}

        $D->titlePhantom = $this->lang('admin_ads_profile_add_title_page');
		...
		$D->page_title = $this->lang('admin_ads_profile_add_title_page');    	

        $D->file_in_template = 'max/admin-ads-profile-add.php';
