...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            ...
            $for_load = 'min/admin-static-pages-add.php';

		} else {

            $for_load = 'max/admin-static-pages-add.php';

		}

        $D->titlePhantom = $this->lang('admin_static_pages_add_title_page');
		...
		$D->page_title = $this->lang('admin_static_pages_add_title_page');    	

        $D->file_in_template = 'max/admin-static-pages-add.php';
