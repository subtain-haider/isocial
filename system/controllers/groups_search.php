...
*/
	...
	if ($D->isPhantom) {
		...
		if ($D->layout_size == 'min') {
            $for_load = 'min/groups-search.php';
		} else {
            $for_load = 'max/groups-search.php';
		}

        $D->titlePhantom = $this->lang('dashboard_groups_search_title');
        ...
        $D->page_title = $this->lang('dashboard_groups_search_title');

        $D->file_in_template = 'max/groups-search.php';
