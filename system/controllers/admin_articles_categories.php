...
*/
    ...
    $items = $this->db2->fetch_all("SELECT * FROM articles_cat WHERE idfather=0 ORDER BY name ASC");
    ...
    foreach ($items as $oneitem) {
        ...
        $D->html_items .= $this->load_template('ones/one-category-article.php', FALSE);
    }
