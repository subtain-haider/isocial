...
*/
	...
	if ($D->isPhantom) {
        ...
        if ($D->layout_size == 'min') {
            $for_load = 'min/albums-create.php';
		} else {
            $for_load = 'max/albums-create.php';
		}

        $D->titlePhantom = $this->lang('dashboard_albums_create_title_page');
        ...
        $D->page_title = $this->lang('dashboard_albums_create_title_page');

        $D->file_in_template = 'max/albums-create.php';
