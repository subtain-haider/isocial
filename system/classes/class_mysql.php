...
class mysql
{
    ...
    public function __construct($host, $user, $pass, $db)
    {
        ...
        $this->dbpass = $pass;
        $this->dbname = $db;
        $this->debug_mode = $GLOBALS['K']->DEBUG_MODE;
        ...
        $this->ext = 'mysql';
        if( isset($GLOBALS['K']) && isset($GLOBALS['K']->DB_MYEXT) && $GLOBALS['K']->DB_MYEXT=='mysqli' && function_exists('mysqli_connect') ) {
            $this->ext = 'mysqli';
        }
    ...
    public function connect()
    {
        ...
        $this->ext=='mysqli' ? mysqli_query($this->connection, "SET SESSION sql_mode=''") : mysql_query("SET SESSION sql_mode=''", $this->connection);
        if($this->debug_mode) {
