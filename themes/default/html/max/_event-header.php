        ...
        <div id="area-menu-header" class="ingroup">
            <div id="inside-menu" class="ingroup">
                <div id="in-content">
                    ...
                    <a href="<?php echo $K->SITE_URL?>" id="menu-more-profile-link" <?php echo($D->_IS_LOGGED ? 'rel="phantom" target="profile-content-area"' : '') ?> class="one-option no_in_tablet yes_in_movil yes_in_movil_land"><span><?php echo($this->lang('profile_txt_more'));?></span> <span><img src="<?php echo getImageTheme('ico-more-menu.png')?>"></span></a>
