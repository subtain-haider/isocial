<div class="product-in-post" id="the_prod<?php echo $D->product_code; ?>">
    <div class="area1">
    ...
    <div class="area2">
        ...
        <div class="block-info" style="margin-top:15px;">
            <div id="bseller_the_prod<?php echo $D->product_code; ?>" class="my-btn my-btn-blue"><?php echo $this->lang('activity_txt_message_seller')?></div>
            <script>
                $('#bseller_the_prod<?php echo $D->product_code; ?>').click(function(e){
                    e.preventDefault();
        ...
        <div class="block-info" style="margin-top:10px;">
            <div class="nologin">
                <div class="msg"><?php echo $this->lang('global_txt_nonlogin_product'); ?></div>
                <div><a href="<?php echo $K->SITE_URL?>login"><button class="btnl"><?php echo $this->lang('global_txt_nonlogin_blogin')?></button></a></div>
            </div>
        </div>
