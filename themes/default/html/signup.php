...
<div id="generic-main-area">
    ...
    <div id="area-register">
        ...
        <div id="area-form">
            ...
            <div style="margin-top: 15px;"><input type="text" class="boxinput" name="lastname" id="lastname" placeholder="<?php echo $this->lang('signup_lastname')?>"></div>
            <div id="alert-lastname" class="alert alert-red hide"></div>
            
            <div style="margin-top: 15px;"><input type="text" class="boxinput" name="email" id="email" placeholder="<?php echo $this->lang('signup_email')?>"></div>
            <div id="alert-email" class="alert alert-red hide"></div>
            
            <div style="margin-top: 15px;"><input type="text" class="boxinput" name="username" id="username" placeholder="<?php echo $this->lang('signup_username')?>"></div>
            <div id="alert-username" class="alert alert-red hide"></div>
            
            <div style="margin-top: 15px;"><input type="password" class="boxinput" name="password" id="password" placeholder="<?php echo $this->lang('signup_password')?>"></div>
