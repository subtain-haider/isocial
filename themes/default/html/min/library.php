                ...
                <div id="dashboard-one-space" style="margin-top:10px;">
                    ...
                    <div class="box-white">
                        <div class="box-white-header-clean">
                            ...
                            <div class="title withico"><?php echo $this->lang('library_title'); ?></div>
                            
                            <div class="some-right withico"><span><img style="width:11px; height:11px;" src="<?php echo getImageTheme('ico-glass.png'); ?>" alt=""></span> <span class="link link-blue bold" id="link-filter"><?php echo $this->lang('library_txt_filter')?></a></span></div>
                        ...
                        <div class="box-white-body <?php echo($D->open_filter ? '' : 'hide')?>" id="space-filter">
                            ...
                            <div>
                                ...
                                <div class="form-block library-categories">
                                    <label for="categorylibrary"><?php echo $this->lang('library_txt_categories')?>:</label>
                                    <select name="categorylibrary" id="categorylibrary" class="form-control" onchange="loadsubcategorylibrary(this.value, <?php echo $D->l_category?>, '<?php echo $this->lang('library_txt_all')?>','#subcategorymarket');"></select>
                                </div>
                                <div class="form-block mkplace-categories">
                                    <label for="subcategorylibrary"><?php echo $this->lang('library_txt_subcategories')?>:</label>
                                    <select name="subcategorylibrary" id="subcategorylibrary" class="form-control"></select>
                                </div>

                                <div class="clear"></div>
                                
                                <div class="centered" style="margin-top:10px;"><span id="bfilter" class="my-btn my-btn-small"><?php echo $this->lang('library_btn_filter')?></span></div>
                    ...
                    <script>
                        ...
                        var msgccategories = stripslashes('<?php echo strJS($this->lang('library_txt_all'))?>');
                        var msgcsubcategories = stripslashes('<?php echo strJS($this->lang('library_txt_all'))?>');
                    ...
                    <div class="box-activity-no-item" style="margin-top:20px;">
                        <div class="inside-text">
                            <?php echo $this->lang('library_empty'); ?>
                        </div>
                    </div>
