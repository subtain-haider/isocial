                        ...
                        <div class="box-white-body">
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="form-block">
                                    ...
                                    <input name="fbappid" type="text" id="fbappid" placeholder="<?php echo $this->lang('admin_general_block_fblogin_appid')?>" class="form-control" value="<?php echo $D->fb_appid;?>"/>
                                </div>

                                <div class="form-block">
                                    <label for="appsecret"><?php echo $this->lang('admin_general_block_fblogin_appsecret')?></label>
                                    <input name="appsecret" type="text" id="appsecret" placeholder="<?php echo $this->lang('admin_general_block_fblogin_appsecret')?>" class="form-control" value="<?php echo $D->fb_appsecret;?>"/>
                                </div>
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="subtitle"><?php echo $this->lang('admin_general_block_modules_title')?></div>

                                <form id="form10" name="form10" method="post" action="">
                                
                                <div class="form-block">
                                    <label for="modpages"><?php echo $this->lang('admin_general_block_modules_pages')?>:</label>
                                    <select name="modpages" id="modpages" class="form-control">
                                        <option value="0" <?php echo($D->m_with_pages == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_disabled')?></option>
                                        <option value="1" <?php echo($D->m_with_pages == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_enabled')?></option>
                                    </select>
                                </div>

                                <div class="form-block">
                                    <label for="modgroups"><?php echo $this->lang('admin_general_block_modules_groups')?>:</label>
                                    <select name="modgroups" id="modgroups" class="form-control">
                                        <option value="0" <?php echo($D->m_with_groups == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_disabled')?></option>
                                        <option value="1" <?php echo($D->m_with_groups == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_enabled')?></option>
                                    </select>
                                </div>

                                <div class="form-block">
                                    <label for="modevents"><?php echo $this->lang('admin_general_block_modules_events')?>:</label>
                                    <select name="modevents" id="modevents" class="form-control">
                                        <option value="0" <?php echo($D->m_with_events == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_disabled')?></option>
                                        <option value="1" <?php echo($D->m_with_events == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_enabled')?></option>
                                    </select>
                                </div>


                                <div class="form-block">
                                    <label for="modmarket"><?php echo $this->lang('admin_general_block_modules_marketplace')?>:</label>
                                    <select name="modmarket" id="modmarket" class="form-control">
                                        <option value="0" <?php echo($D->m_with_marketplace == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_disabled')?></option>
                                        <option value="1" <?php echo($D->m_with_marketplace == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_enabled')?></option>
                                    </select>
                                </div>


                                <div class="form-block">
                                    <label for="modlibrary"><?php echo $this->lang('admin_general_block_modules_library')?>:</label>
                                    <select name="modlibrary" id="modlibrary" class="form-control">
                                        <option value="0" <?php echo($D->m_with_library == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_disabled')?></option>
                                        <option value="1" <?php echo($D->m_with_library == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_enabled')?></option>
                                    </select>
                                </div>

                                <div class="form-block">
                                    <label for="modgames"><?php echo $this->lang('admin_general_block_modules_games')?>:</label>
                                    <select name="modgames" id="modgames" class="form-control">
                                        <option value="0" <?php echo($D->m_with_games == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_disabled')?></option>
                                        <option value="1" <?php echo($D->m_with_games == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_enabled')?></option>
                                    </select>
                                </div>

                                <div id="msgerror10" class="alert alert-red hide"></div>
                                <div id="msgok10" class="alert alert-green hide"></div>
                                <div><input type="submit" name="bsave10" id="bsave10" value="<?php echo $this->lang('admin_txt_save_changes')?>" class="my-btn my-btn-blue"/></div>
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="subtitle"><?php echo $this->lang('admin_general_block_gdpr_title')?></div>

                                <form id="form11" name="form11" method="post" action="">
                                
                                <div class="form-block">
                                    <label for="modgdpr"><?php echo $this->lang('admin_general_block_gdpr_consent')?>:</label>
                                    <select name="modgdpr" id="modgdpr" class="form-control">
                                        <option value="0" <?php echo($D->m_with_gdpr == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_disabled')?></option>
                                        <option value="1" <?php echo($D->m_with_gdpr == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_enabled')?></option>
                                    </select>
                                </div>

                                <div id="msgerror11" class="alert alert-red hide"></div>
                                <div id="msgok11" class="alert alert-green hide"></div>
                                <div><input type="submit" name="bsave11" id="bsave11" value="<?php echo $this->lang('admin_txt_save_changes')?>" class="my-btn my-btn-blue"/></div>
                            ...
                            <div class="areablock space-in-admin">
                                ...
                                <div class="subtitle"><?php echo $this->lang('admin_general_block_hashtag_title')?></div>

                                <form id="form12" name="form12" method="post" action="">
                                <div class="form-block">
                                    <label for="hash_status"><?php echo $this->lang('admin_general_block_hashtag_status')?>:</label>
                                    <select name="hash_status" id="hash_status" class="form-control">
                                        <option value="0" <?php echo($D->m_with_hashtag == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_disabled')?></option>
                                        <option value="1" <?php echo($D->m_with_hashtag == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_txt_enabled')?></option>
                                    </select>
                                </div>


                                <div class="form-block">
                                    <label for="hash_interval"><?php echo $this->lang('admin_general_block_hashtag_interval'); ?>:</label>
                                    <select name="hash_interval" id="hash_interval" class="form-control">
                                        <option value="0" <?php echo($D->m_with_hashtag_interval == 0 ?'selected="selected"' : '');?>><?php echo $this->lang('admin_general_block_hashtag_interval_0')?></option>
                                        <option value="1" <?php echo($D->m_with_hashtag_interval == 1 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_block_hashtag_interval_1')?></option>
                                        <option value="1" <?php echo($D->m_with_hashtag_interval == 2 ? 'selected="selected"' : '');?>><?php echo $this->lang('admin_general_block_hashtag_interval_2')?></option>
                                    </select>
                                </div>

                                <div class="form-block">
                                    <label for="hash_limit"><?php echo $this->lang('admin_general_block_hashtag_limit')?>:</label>
                                    <input name="hash_limit" type="text" id="hash_limit" placeholder="<?php echo $this->lang('admin_general_block_hashtag_limit')?>" class="form-control" value="<?php echo $D->m_with_hashtag_limit; ?>"/>
                                </div>

                                <div id="msgerror12" class="alert alert-red hide"></div>
                                <div id="msgok12" class="alert alert-green hide"></div>
                                <div><input type="submit" name="bsave12" id="bsave12" value="<?php echo $this->lang('admin_txt_save_changes')?>" class="my-btn my-btn-blue"/></div>
...
<script>
    ...
    $('#bsave10').on('click', function(e){
        e.preventDefault();
        updateModules('#msgerror10', '#msgok10', '#bsave10');
    });

    $('#bsave11').on('click', function(e){
        e.preventDefault();
        updateGDPR('#msgerror11', '#msgok11', '#bsave11');
    });

    var txt_error_hash_limit = stripslashes('<?php echo strJS($this->lang('admin_general_block_hashtag_error_limit'))?>');
    $('#bsave12').on('click', function(e){
        e.preventDefault();
        updateHashtagM('#msgerror12', '#msgok12', '#bsave12');
    });
