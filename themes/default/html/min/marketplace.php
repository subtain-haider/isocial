               ...
               <?php if(isset($D->js_script_min)) echo $D->js_script_min;?>
                <div id="dashboard-one-space" style="margin-top:10px;">

                    <div class="box-white">
                        <div class="box-white-header-clean">

                            <div class="ico"><img src="<?php echo getImageTheme('i-m-marketplace.png'); ?>"></div>
                            <div class="title withico"><?php echo $this->lang('marketplace_title'); ?></div>
                            
                            <div class="some-right withico"><span><img style="width:11px; height:11px;" src="<?php echo getImageTheme('ico-glass.png'); ?>" alt=""></span> <span class="link link-blue bold" id="link-filter"><?php echo $this->lang('marketplace_txt_filter')?></a></span></div>
                        ...
                        <div class="box-white-body <?php echo($D->open_filter ? '' : 'hide')?>" id="space-filter">
                            ...
                            <div>
                                <div class="form-block mkplace-categories">
                                    <label for="categorymarket"><?php echo $this->lang('marketplace_txt_categories')?>:</label>
                                    <select name="categorymarket" id="categorymarket" class="form-control" onchange="loadsubcategorymarket(this.value, <?php echo $D->m_category?>, '<?php echo $this->lang('marketplace_txt_all')?>','#subcategorymarket');"></select>
                                </div>
                                <div class="form-block mkplace-categories">
                                    <label for="subcategorymarket"><?php echo $this->lang('marketplace_txt_subcategories')?>:</label>
                                    <select name="subcategorymarket" id="subcategorymarket" class="form-control"></select>
                                </div>

                                <div class="clear"></div>
                                
                                <div class="centered" style="margin-top:10px;"><span id="bfilter" class="my-btn my-btn-small"><?php echo $this->lang('marketplace_btn_filter')?></span></div>
                    ...
                    <script>
                        ...
                        var msgccategories = stripslashes('<?php echo strJS($this->lang('marketplace_txt_all'))?>');
                        var msgcsubcategories = stripslashes('<?php echo strJS($this->lang('marketplace_txt_all'))?>');
                        ...
                        $('#bfilter').click(function(){
                            ...
                            <?php if ($D->_IS_LOGGED) { ?>
                            actionOnClick(_SITE_URL + 'marketplace/c:' + cat + '/s:' + subcat, '<?php echo $D->id_container?>-main-area', 'min');
                            <?php } else { ?>
                            location.href = _SITE_URL + 'marketplace/c:' + cat + '/s:' + subcat;
                            <?php } ?>
                        });
                        </script>
                    ...
                    <div class="box-activity-no-item" style="margin-top:20px;">
                        <div class="inside-text">
                            <?php echo $this->lang('marketplace_empty'); ?>
                        </div>
                    </div>
