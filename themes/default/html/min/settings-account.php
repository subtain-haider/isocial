                    ...
                    <div class="box-white mrg30B">
                        ...
                        <div class="box-white-body">
                            ...
                            <div class="areablock space-in-setting">
                                ...
                                <div class="form-block">
                                    <label for="timezone"><?php echo $this->lang('setting_account_block_langtimezone_tomezone')?></label>
                                ...
                                <div class="form-block">
                                    <label for="language"><?php echo $this->lang('setting_account_block_langtimezone_language')?></label>
