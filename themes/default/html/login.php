...
<div id="generic-main-area">
    ...
    <div id="area-login">
        ...
        <div id="area-form">
            ...
            <div style="margin-top: 20px;"><input type="password" class="boxinput" name="password" id="password" placeholder="<?php echo $this->lang('login_password')?>"></div>
            ...
            <div id="arearemember"><input type="checkbox" name="rememberme" id="rememberme"><span style="padding:5px; padding-left:5px; font-size:14px; line-height:20px; color:#666;"><?php echo $this->lang('login_txt_rememberme')?></span></div>
            <?php } ?>
            </form> 
